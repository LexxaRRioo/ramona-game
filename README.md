...
2. First launch: double-click Ramona in Applications. macOS blocks it with "Apple could not verify..." — click **Done**, 
![alt text](images/image.png)
then go to **System Settings → Privacy & Security**, scroll to Security, and click **Open Anyway** next to Ramona. 
![alt text](images/image-1.png)
Confirm once more and she'll launch. This is only needed once.
